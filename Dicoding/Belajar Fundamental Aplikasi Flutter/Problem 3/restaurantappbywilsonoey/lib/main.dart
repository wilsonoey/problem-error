...
import 'package:restaurantappbywilsonoey/widgets/cart_restaurant_detail.dart';
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        RestaurantDetailPage.routeName: (context) =>
            RestaurantDetailPage(restaurantdetail: ModalRoute.of(context)?.settings.arguments as RestaurantDetailProvider,),
