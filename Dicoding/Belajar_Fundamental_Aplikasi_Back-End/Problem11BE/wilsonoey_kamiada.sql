...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2024 at 07:56 AM
...
--
-- Table structure for table `errorkad`
--

CREATE TABLE `errorkad` (
  `iderror` varchar(30) NOT NULL,
  `detailerror` text NOT NULL,
  `createdaterror` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indexes for table `errorkad`
--
ALTER TABLE `errorkad`
